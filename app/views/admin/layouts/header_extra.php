...
<head>
    ...
    <link href="/public/admin/plugins/fileuploads/css/fileupload.css" rel="stylesheet" type="text/css"/>

    <!---Internal Fancy uploader css-->
    <link href="/public/admin/plugins/fancyuploder/fancy_fileupload.css" rel="stylesheet" />

    <!--Internal Sumoselect css-->
    <link rel="stylesheet" href="/public/admin/plugins/sumoselect/sumoselect.css">

    <!--Internal  TelephoneInput css-->
    <link rel="stylesheet" href="/public/admin/plugins/telephoneinput/telephoneinput.css">
    ...
    <aside class="app-sidebar sidebar-scroll">
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                <li class="side-item side-item-category">فروشگاه </li>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li><a class="slide-item" href="/panel/product">محصولات</a></li>
                        <li><a class="slide-item" href="/panel/createproduct">افزودن محصول</a></li>
                    </ul>
                </li>
            </ul>
        </div>

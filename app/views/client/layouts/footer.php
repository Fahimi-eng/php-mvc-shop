                ...
                <nav class="footer-feature-innerbox mb-1">
                    <div class="footer-badge-item">
                        <a href="#" class="footer-badge-link">
                            <img src="/public/client/images/footer/delivery.svg">
                            <span class="footer-badge-title">تحویل اکسپرس</span>
                        </a>
                    </div>
                    <div class="footer-badge-item">
                        <a href="#" class="footer-badge-link">
                            <img src="/public/client/images/footer/contact-us.svg">
                            <span class="footer-badge-title">پشتیبانی 24 ساعته</span>
                        </a>
                    </div>
                    <div class="footer-badge-item">
                        <a href="#" class="footer-badge-link">
                            <img src="/public/client/images/footer/payment-terms.svg">
                            <span class="footer-badge-title">پرداخت درمحل</span>
                        </a>
                    </div>
                    <div class="footer-badge-item">
                        <a href="#" class="footer-badge-link">
                            <img src="/public/client/images/footer/return-policy.svg">
                            <span class="footer-badge-title">۷ روز ضمانت بازگشت</span>
                        </a>
                    </div>
                    <div class="footer-badge-item">
                        <a href="#" class="footer-badge-link">
                            <img src="/public/client/images/footer/origin-guarantee.svg">
                ...
                <article class="container-main">
                        ...
                        <div class="col-lg-4 col-md-4 col-xs-12 pull-left">
                            <div class="footer-form">
                                <form action="#" class="form-newsletter mb-4 mt-4">
                                    <fieldset>
                                        <span class="form-newsletter-title">از تخفیف‌ها و جدیدترین‌های باخبرشوید:</span>
                                    ...
                                    <div class="footer-community">
                                        <div class="footer-social mb-4 mt-4">
                                            <span را در شبکه‌های اجتماعی دنبال کنید:</span>
                                    ...
                                    <aside>
                                        <ul class="footer-safety-partner mt-4 pull-left">
                                            <li class="footer-safety-partner-1">
                                                <a href="#">
                                                    <img src="/public/client/images/footer/license/L-2.png">
                                                </a>
                                            </li>
                                            <li class="footer-safety-partner-1">
                                                <a href="#">
                                                    <img src="/public/client/images/footer/license/L-1.png">
                                                </a>
                                            </li>
                                        </ul>
                                    </aside>
                    ...
                    <div class="footer-copyright">
                        <div class="footer-copyright-text">
                            استفاده از مطالب فروشگاه اینترنتی فقط برای مقاصد غیرتجاری و با ذکر منبع
                            بلامانع است. کلیه حقوق این سایت متعلق به شرکت نوآوران فن آوازه (فروشگاه آنلاین) می‌باشد.
                        </div>
                    </div>
                </article>
        </footer>
...
<!-- sweetalert2--------------------------------->
<script src="/public/client/js/sweetalert2.all.min.js"></script>
<!--main----------------------------------------->

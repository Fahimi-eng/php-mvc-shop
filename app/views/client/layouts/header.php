...
<head>
    ...
    <link rel="stylesheet" href="/public/client/css/materialdesignicons.css.map">
    <!--    bootstrap------------------------------->
    <link rel="stylesheet" href="/public/client/css/bootstrap.css">
    <!--    owl.carousel---------------------------->
    <link rel="stylesheet" href="/public/client/css/owl.carousel.min.css">
    <!-- sweetalert2-------------------------------->
    <link rel="stylesheet" href="/public/client/css/sweetalert2.min.css">
    <!--    responsive------------------------------>
                        ...
                        <div class="search-header">
                            <form action="#">
                                ...
                                <button type="submit" class="button-search">
                                    <img src="/public/client/images/search.png">
                                </button>
                            </form>
                ...
                <div class="header-left">
                    <ul class="nav-lr">
                        <li class="nav-item-account">
                            <a href="#">
                                <img src="/public/client/images/user.png" alt="user">
                                حساب کاربری
                            ...
                            <ul class="sub-menu">
                                <li class="list-item-children">
                                    <a href="#" class="list-item-children-category">
                                       <img src="/public/client/images/menu/icon/carpet.png">
                                        فروش تابلو فرش
                                    </a>
                                    <ul class="megamenu-level-3" style="display:block">
                                        ...
                                        <li class="images-menu-list">
                                            <a href="#">
                                                <img src="/public/client/images/menu/ryan-christodoulou-789566-unsplash.jpg">
                                ...
                                <li class="list-item-children">
                                    <a href="#" class="list-item-children-category">
                                        <img src="/public/client/images/menu/icon/necklace.png">
                                        طلا و جواهر
                                    </a>
                                    <ul class="megamenu-level-3">
                                        ...
                                        <li class="images-menu-list">
                                            <a href="#">
                                                <img src="/public/client/images/menu/Jewelry.jpg">
                                                <div class="box-shadow"></div>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="list-item-children">
                                    <a href="#" class="list-item-children-category">
                                        <img src="/public/client/images/menu/icon/digital.png">
                                        کالای دیجیتال
                                    </a>
                                    <ul class="megamenu-level-3">
                                        ...
                                        <li class="images-menu-list">
                                            <a href="#">
                                                <img src="/public/client/images/menu/311-3114215_macbook-pro-office-photography.jpg">
                                                <div class="box-shadow"></div>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="list-item-children">
                                    <a href="#" class="list-item-children-category">
                                        <img src="/public/client/images/menu/icon/dishes.png">
                                        ظروف
                                    </a>
                                    <ul class="megamenu-level-3">
                                        ...
                                        <li class="images-menu-list">
                                            <a href="#">
                                                <img src="/public/client/images/menu/viennese_waffles_waffles_fruits_178672_1920x1080.jpg">
                                                <div class="box-shadow"></div>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="list-item-children">
                                    <a href="#" class="list-item-children-category">
                                        <img src="/public/client/images/menu/icon/dress.png">
                                        پوشاک
                                    </a>
                                    <ul class="megamenu-level-3">
                                        ...
                                        <li class="images-menu-list">
                                            <a href="#">
                                                <img src="/public/client/images/menu/190-1900787_image-may-contain-clothing-apparel-boutique-and-shop.jpg">
                                                <div class="box-shadow"></div>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="list-item-children">
                                    <a href="#" class="list-item-children-category">
                                        <img src="/public/client/images/menu/icon/couch.png">
                                        خانه و آشپزخانه
                                    </a>
                                    <ul class="megamenu-level-3">
                                        ...
                                        <li class="images-menu-list">
                                            <a href="#">
                                                <img src="/public/client/images/menu/sofa_decoration_interior_vase_lamp_white_background_80205_1920x1080.jpg">
                                                <div class="box-shadow"></div>
                                            </a>
                                        </li>
                                    </ul>
                                                    ...
                                                    <a href="#">
                                                        <li class="dropdown-item">
                                                            <div class="title-cart">
                                                                <img src="/public/client/images/cart/lenovo-ideapadl3-15iml05.jpg">
                                                        ...
                                                        <li class="dropdown-item">
                                                            <div class="title-cart">
                                                                <img src="/public/client/images/cart/huawei-p40pro.jpg">
                                                        ...
                                                        <li class="dropdown-item">
                                                            <div class="title-cart">
                                                                <img src="/public/client/images/cart/asus-ZenBookDuo-UX481FL.jpg">
                                                        ...
                                                        <li class="dropdown-item">
                                                            <div class="title-cart">
                                                                <img src="/public/client/images/cart/galaxy-watch-active2.jpg">
...
<!--              <img class="pic-header" src="images/header-pic.jpg" alt="">-->
              ...
              <div class="logo-wrap">
                <a class="logo-icon" href="#"><img alt="logo-icon" src="/public/client/images/logo.png" width="40"></a>
              </div>
            </div>
